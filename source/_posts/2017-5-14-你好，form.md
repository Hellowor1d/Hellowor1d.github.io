...
![](../img/posts-imgs/form/form_sample_form.png)
...
![](../img/posts-imgs/form//form_data_receive.png)
...
![](../img/posts-imgs/form//form-auto-complete.png)
...
![](../img/posts-imgs/form//form_element.png)
...
![](../img/posts-imgs/form//form-reset.png)
...
![](../img/posts-imgs/form//form_file_upload.png)

- `control` 属性：如果指定了 `for` 属性则指定该`for` 属性对于 `id` 的可关联元素。如果没有指定 `for` 属性则为第一个可关联的子孙元素。

![](../img/posts-imgs/form/for_label.png)
...
![](../img/posts-imgs/form//form_select.png)
...
![](../img/posts-imgs/form//form_supportability.jpg)
...
![](../img/posts-imgs/form//form_validity.png)
...
![](../img/posts-imgs/form//form_submit_data_type.png)

![](../img/posts-imgs/form//form_submit_data_2.png)

![](../img/posts-imgs/form//form_submit_data_type1.png)
...
![](../img/posts-imgs/form//form_special_case.png)
...
![](../img/posts-imgs/form//form_speicla_calse2.png)
...
![](../img/posts-imgs/form//form_ifram_submit_data.png)
...
![](../img/posts-imgs/form//form_app_code.png)
